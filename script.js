...
// Function to show modal, focus on input
function showModal() {
...
function buildBookmarks() {
    ...
    bookmarks.forEach((bookmark) => {
        ...
        favicon.setAttribute('alt', 'Faivicon');
        // Link
        ...
        // Append to bookmarks container, order matters
...
function fetchBookmarks() {
    ...
    if (localStorage.getItem('bookmarks')) {
        ...
        bookmarks = [
            {
                name: 'DJamme Design',
                url: 'https://jamme-d.github.io/Animated-Navigation/',
            },
        ];
